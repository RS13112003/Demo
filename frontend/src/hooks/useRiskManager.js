...
const API_URL = `${API_BASE_URL}/api/assess-risk`
  ...
  const validateCsvFile = async (file) => {
    ...
    const loadDataset = async (datasetKey) => {
      const DATASET_URLS = {
          ...
          // original: `${API_BASE_URL}/api/demo/original-dataset`
      ...
      const DATASET_NAMES = {
        ...
        // original : 'tranning_dataset_creditcard.csv'
      }
